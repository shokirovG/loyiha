...
const Footer = () => {
  return (
    <div className="w-[100%] h-[160vh] text-[16px] text-[#9E9E9E] flex flex-col justify-between mt-10">
      ...
      <div className="sm:flex sm:flex-col md:flex lg:flex xl:flex /FOOTER/ items-center justify-evenly w-[100%] bg-white h-[376px] rounded-lg">
        ...
        <div className="w-[734px] h-[184px] flex justify-between mb-5">
        ...
        <div className="w-[246px] h-[248px] flex flex-col justify-between pt-[20px] items-center">
