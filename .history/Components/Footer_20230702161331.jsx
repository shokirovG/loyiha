...
const Footer = () => {
  return (
    <div className="bigOne w-[100%] min-h-[160vh] gap-[50px] text-[16px] text-[#9E9E9E] flex flex-col justify-between mt-10">
      <div className="flex justify-evenly adv w-[85%] bg-white m-auto rounded-[20px]">
        <div className="flex flex-col items-start justify-around w-[540px] h-[304px] mt-[90px]">
          <h1 className="text-[#1D1D1F] text-[47px] font-[700] newHead">
          ...
          <div className="w-[236px] flex justify-between mt-4">
            <Image src={"/imgs/appstore.png"} width={110} height={37} />
            <Image src={"/imgs/google.png"} width={110} height={37} />
          </div>
        </div>
        <Image src={"/imgs/newTel.png"} width={500} height={744} />
      </div>
      ...
      <div className="footer flex items-center justify-evenly max-w-[100%] bg-white min-h-[376px] rounded-lg">
        ...
        <div className="mb-[40px] ml-12 others w-[246px] min-h-[248px] flex flex-col justify-between pt-[20px] items-center">
          <div className="w-[246px] h-[194] gap-[5px] flex flex-col">
            <h1
              className="title text-[42px] text-[#1D1D1F] font-[700]"
              id="title"
            >
              #NinjaSushi
            </h1>
            <p className="text-[#9E9E9E] text-[16px] line-[24px]" id="texts">
              Ninja Sushi в фотографиях наших клиентов
            </p>
            <button
              id="button"
              className="w-[246px] h-[56px] bg-[#F5F5F7] rounded-[12px] text-[#00CC2D] font-[500] text-[16px] font-[Inter]"
            >
