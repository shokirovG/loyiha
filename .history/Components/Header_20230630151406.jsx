...
const Header = () => {
  return (
    <header className="flex items-center w-screen justify-around h-24 bg-white mb-[16px]">
      ...
      <div className="flex items-center w-3/4 justify-between">
        ...
        <div className="flex items-center w-80 h-14">
          <button className="flex w-12 border items-center justify-center h-10 rounded-lg">
            <Image src="/imgs/bell.PNG" alt="logo" width={24} height={24} />
          </button>
          <button className="flex w-12 border items-center ml-2 justify-center h-10 rounded-lg">
            <Image src="/imgs/like.PNG" alt="logo" width={24} height={24} />
          </button>
          <button className="flex w-12 border items-center ml-2 justify-center h-10 rounded-lg">
            <Image src="/imgs/person.PNG" alt="logo" width={24} height={24} />
          </button>
          <button className="p-4 flex w-32 justify-around ml-2 border items-center h-10 rounded-lg">
            <span>Корзина</span>
