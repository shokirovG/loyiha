...
export const ChickFoodItem = ({ strMeal, idMeal, strMealThumb }) => {
  return (
    <div className="w-96 min-h-3/4 bg-white mt-8 p-7 rounded-2xl flex flex-col items-start gap-2 ">
      ...
      <div className="w-[90%] flex justify-between">
        ...
        <div className="flex w-[136px] justify-center gap-[12px]">
          ...
          <div className="flex items-center justify-center bg-[#F5F5F7] rounded-md w-[60px] h-[36px] cursor-pointer">
