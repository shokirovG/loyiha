  ...
  return (
    <div className="bigOne w-[100%] min-h-[160vh] gap-[50px] text-[16px] text-[#9E9E9E] flex flex-col justify-between mt-10">
      <div className="flex justify-around adv w-[100%] border-[3px]">
        <div className="flex flex-col items-start justify-around w-[540px] h-[304px] border-[3px] mt-[50px]">
          <h1 className="text-[#1D1D1F] text-[45px] font-[700] newHead">
          ...
          <div className="w-[246px] flex justify-around mt-5 mr-2">
