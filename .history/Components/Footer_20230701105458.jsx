...
const Footer = () => {
  return (
    <div className="w-[100%] min-h-[160vh] text-[16px] text-[#9E9E9E] flex flex-col justify-between mt-10">
      ...
      <div className="footer flex items-center justify-evenly max-w-[100%] bg-white min-h-[376px] rounded-lg">
        ...
        <div className="footer_items max-w-[754px] min-h-[184px] flex justify-between mb-5">
          <ul className="flex flex-col gap-[5px] max-w-[101px] h-[100%]">
