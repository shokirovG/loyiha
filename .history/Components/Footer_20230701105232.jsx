...
const Footer = () => {
  return (
    <div className="w-[100%] h-[160vh] text-[16px] text-[#9E9E9E] flex flex-col justify-between mt-10">
      ...
      <div className="FOOTER flex items-center justify-evenly max-w-[100%] bg-white min-h-[576px] rounded-lg">
        ...
        <div className="footer_items max-w-[734px] min-h-[184px] flex justify-between mb-5">
        ...
        <div className="others max-w-[246px] min-h-[248px] flex flex-col justify-between pt-[20px] items-center">
          <div className="w-[246px] h-[194] gap-[5px] flex flex-col">
            <h1 className="text-[42px] text-[#1D1D1F] font-[700]">
              #NinjaSushi
            </h1>
