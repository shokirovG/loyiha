...
const Footer = () => {
  return (
    <div className="w-[100%] border h-[160vh] text-[16px] text-[#9E9E9E] flex flex-col justify-between mt-10">
      ...
      <div className="/FOOTER/ flex items-center justify-evenly w-[100%] bg-white h-[376px] rounded-lg">
        ...
        <div className="w-[246px] h-[248px] border flex flex-col justify-between pt-[20px] items-center">
          <div>
            ...
            <button className="w-[246px] h-[56px] bg-[#F5F5F7] rounded-[12px] text-[#00CC2D] font-[500] text-[16px] font-mono">
