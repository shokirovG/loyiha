...
const Header = () => {
  return (
    <header className="sm:w-auto p-5 md:flex lg:flex 2xl:flex items-center w-screen justify-around h-24 bg-white mb-[16px]">
      ...
      <div className="flex items-center w-3/4 justify-between sm:flex-col md:flex md:items-center md:justify-between lg:flex lg:items-center lg:justify-between">
