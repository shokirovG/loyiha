...
const Header = () => {
  return (
    <header className="sm:w-auto p-5 md:flex lg:flex 2xl:flex items-center w-screen justify-around h-24 bg-white mb-[16px]">
      ...
      <div className="items-center w-3/4 justify-between sm:flex-col md:flex lg:flex">
        <ul className="flex items-center w-3/6 justify-between gap-12 sm:flex-wrap md:flex lg:flex 2xl:flex 3l:flex">
