      ...
      <SwiperSlide>
        <div className="flex justify-center w-[100%]">
          <div className="w-[7065px] p-[50px] flex flex-col items-center">
            ...
            <h3 className="text-left w-[565px] mt-[20px]">
              Доставку делаем с 10:00 до 19:30
            </h3>
            <button className="w-[263px] h-[22px] bg-[#00CC2D] p-5 flex items-center justify-center rounded-[12px] text-white text-[16px] float-left">
              Перейти к новости
            </button>
          </div>
          <Image
