...
const Footer = () => {
  return (
    <div className="w-[100%] border h-[140vh] text-[16px] text-[#9E9E9E] flex flex-col justify-between mt-10">
      ...
      <div className="footer w-[100%] bg-white h-[248px] rounded-lg">
        <div>
          <div>
            <Image src={"/imgs/logo.png"} width={246} height={59} />
            <div className="flex">
              <Image src={"/imgs/appstore.png"} width={246} height={59} />
              <Image src={"/imgs/google.png"} width={246} height={59} />
            </div>
          </div>
        </div>
        <div></div>
