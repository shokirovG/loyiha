...
const Footer = () => {
  return (
    <div className="w-[100%] border h-[160vh] text-[16px] text-[#9E9E9E] flex flex-col justify-between mt-10">
      ...
      <div className="/FOOTER/ flex items-center justify-evenly p-10 w-[100%] bg-white h-[376px] rounded-lg">
        ...
        <div className="w-[804px] h-[184px] flex justify-between mb-5">
        ...
        <div>
          ...
          <div className="flex w-[115px] h-[18px] justify-between">
